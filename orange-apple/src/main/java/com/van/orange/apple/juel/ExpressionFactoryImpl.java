 ...
 */
package com.van.orange.apple.juel;
...
import com.van.orange.apple.juel.javax.el.ELException;
import com.van.orange.apple.juel.javax.el.ExpressionFactory;
import com.van.orange.apple.juel.misc.TypeConverter;
import com.van.orange.apple.juel.tree.TreeBuilder;
import com.van.orange.apple.juel.tree.TreeStore;
import com.van.orange.apple.juel.tree.impl.Builder;
import com.van.orange.apple.juel.tree.impl.Cache;
import com.van.orange.apple.juel.tree.impl.Builder.Feature;
 ...
 * <code>META-INF/services/org.cc.orbit.core.juel.javax.el.ExpressionFactory</code>. Calling
 ...
 * <code>org.cc.orbit.core.juel.javax.el.ExpressionFactory</code> whose value is the name of this class, these properties
 * are taken as default properties.</li>
 * <li>Otherwise, if system property <code>org.cc.orbit.core.juel.javax.el.ExpressionFactory</code> is set to the name of
 ...
 * <ul>
 * <li>
 * <code>org.cc.orbit.core.juel.javax.el.cacheSize</code> - cache size (int, default is 1000)</li>
 * <li>
 * <code>org.cc.orbit.core.juel.javax.el.methodInvocations</code> - allow method invocations as in
 * <code>${foo.bar(baz)}</code> (boolean, default is <code>false</code>).</li>
 * <li>
 * <code>org.cc.orbit.core.juel.javax.el.nullProperties</code> - resolve <code>null</code> properties as in
 * <code>${foo[null]}</code> (boolean, default is <code>false</code>).</li>
 * <li>
 * <code>org.cc.orbit.core.juel.javax.el.varArgs</code> - support function/method calls using varargs (boolean, default is
 * <code>false</code>).</li>
 * </ul>
 * 
 * @author Christoph Beck
 */
public class ExpressionFactoryImpl extends com.van.orange.apple.juel.javax.el.ExpressionFactory {
	/**
	 * A profile provides a default set of language features that will define the builder's
	 * behavior. A profile can be adjusted using the <code>org.cc.orbit.core.juel.javax.el.methodInvocations</code>,
	 * <code>org.cc.orbit.core.juel.javax.el.varArgs</code> and <code>org.cc.orbit.core.juel.javax.el.nullProperties</code> properties.
	 * 
	 * @since 2.2
	 */
	public static enum Profile {
		...
		/**
		 * JEE6: <code>org.cc.orbit.core.juel.javax.el.methodInvocations</code>, <code>org.cc.orbit.core.juel.javax.el.varArgs</code>. This is the
		 * default profile.
		 */
	...
	/**
	 * <code>org.cc.orbit.core.juel.javax.el.methodInvocations</code>
	 */
	public static final String PROP_METHOD_INVOCATIONS = "org.cc.orbit.core.juel.javax.el.methodInvocations";

	/**
	 * <code>org.cc.orbit.core.juel.javax.el.varArgs</code>
	 */
	public static final String PROP_VAR_ARGS = "org.cc.orbit.core.juel.javax.el.varArgs";

	/**
	 * <code>org.cc.orbit.core.juel.javax.el.nullProperties</code>
	 */
	public static final String PROP_NULL_PROPERTIES = "org.cc.orbit.core.juel.javax.el.nullProperties";

	/**
	 * <code>org.cc.orbit.core.juel.javax.el.ignoreReturnType</code>
	 */
	public static final String PROP_IGNORE_RETURN_TYPE = "org.cc.orbit.core.juel.javax.el.ignoreReturnType";	
	
	/**
	 * <code>org.cc.orbit.core.juel.javax.el.cacheSize</code>
	 */
	public static final String PROP_CACHE_SIZE = "org.cc.orbit.core.juel.javax.el.cacheSize";
	 ...
	 * be 1000 unless overridden by property <code>org.cc.orbit.core.juel.javax.el.cacheSize</code>. The builder profile is
	 ...
	 * cache size will be 1000 unless overridden by property <code>org.cc.orbit.core.juel.javax.el.cacheSize</code>.
	 * 
	 * @param profile
	...
	private Properties loadDefaultProperties() {
		...
		try {
			if (file.exists()) {
				...
				if (getClass().getName().equals(properties.getProperty("org.cc.orbit.core.juel.javax.el.ExpressionFactory"))) {
					return properties;
				}
			}
		...
		if (getClass().getName().equals(System.getProperty("org.cc.orbit.core.juel.javax.el.ExpressionFactory"))) {
	 ...
	 * property <code>org.cc.orbit.core.juel.javax.el.cacheSize</code>.
	 */
	 ...
	 * <code>org.cc.orbit.core.juel.misc.TypeConverter</code> property as the name of a class implementing
	 * the <code>org.cc.orbit.core.juel.misc.TypeConverter</code> interface. If the property is not set, the
	 ...
	 * <code>org.cc.orbit.core.juel.tree.TreeBuilder</code> property as a name of a class implementing the
	 * <code>org.cc.orbit.core.juel.tree.TreeBuilder</code> interface. If the property is not set, a plain
	 * <code>org.cc.orbit.core.juel.tree.impl.Builder</code> is used. If the configured class is a subclass
	 * of <code>org.cc.orbit.core.juel.tree.impl.Builder</code> and which provides a constructor taking an
