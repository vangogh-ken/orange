 ...
 */ 
package com.van.orange.apple.juel.tree;
...
/**
 * Parsed expression, usually created by a {@link com.van.orange.apple.juel.tree.TreeBuilder}.
 * The {@link #bind(FunctionMapper, VariableMapper)} method is used to create
 * {@link com.van.orange.apple.juel.tree.Bindings}, which are needed at evaluation time to
