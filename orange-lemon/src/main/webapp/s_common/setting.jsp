...
<div class="row" style="height:50px;">
	<div class="col-md-12" style="height:50px;">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<a href="${ctx}/base/dashboard.do" >dashboard</a> 
			<i class="fa fa-angle-right"></i>
			</li>
			<li><a href="#">${currentResource.parentResource.resourceName}</a>
			<i class="fa fa-angle-right"></i>
			</li>
			<li><a href="${ctx}${currentResource.resourceUrl}">${currentResource.resourceName}</a></li>
			<!-- 
			<li class="pull-right">
