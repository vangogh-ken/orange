...
revise log by Vangogh_Ken
20140709 //包裹checkbox的部分,此处取消 Handles custom checkboxes & radios using jQuery Uniform plugin
**/
var App = function () {
    ...
    var handleHorizontalMenu = function () {
       ...
       //handle hor menu message form toggler click
        $('.header').on('click', '.hor-menu .hor-menu-message-form-toggler', function (e) {
            if ($(this).hasClass('off')) {
                $(this).removeClass('off');
                $('.header .hor-menu .message-form').hide();
            } else {
                $(this).addClass('off');
                $('.header .hor-menu .message-form').show();
            }
            e.preventDefault();
        });
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", "/V/s2/assets/css/themes/" + color_ + ".css");
            if ($.cookie) {                
