...
<body class="ecommerce">
    ...
    <script src="${ctx}/s_/assets/global/plugins/gmaps/gmaps.js" type="text/javascript"></script>
    <script src="${ctx}/s_/assets/frontend/pages/scripts/contact-us.js" type="text/javascript"></script>
