...
<html lang="en">
  ...
  <body class="page-header-fixed">
			...
			if(status != '已启用'){
				...
				$.ajax({
					...
					success:function(data){
						...
						html += '<td>批量终止数</td><td colspan="5"><input id="batchEnd" value="0" class="form-control number"></td></tr>';
	...
	function batchBasisAttribute(){
		...
		var data = toJsonString('basisAttributeToAddForm');
		var url = 'basis-attribute-done-add-batch.do?basisSubstanceTypeId=' + basisSubstanceTypeId + '&batchCount=' + batchCount + '&batchStart=' + batchStart + '&batchEnd=' + batchEnd;
		$.ajax({
			type: 'POST',
			data: data,
			url: url,
