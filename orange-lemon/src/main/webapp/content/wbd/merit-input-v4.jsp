							    ...
							    <tr>
							    	<td colspan="4">
								  		<table style="width:100%;table-layout:fixed;">
								  			...
								  			<thead>
								  			<tr class="tr-title"><td colspan="5">工作业绩（副总级）</td></tr>
								  			<tr class="tr-title"><td>项目</td><td colspan="3">完成情况描述</td><td>总经理评分</td></tr>
								  			</thead>
								  			<tbody>
								  			<!-- 1 -->
								  			<tr>
											...
											/>
								  			...
								  			<thead>
								  			<tr class="tr-title"><td colspan="5">工作业绩（后勤类）</td></tr>
								  			<tr class="tr-title"><td >项目</td><td colspan="2">完成情况描述</td><td>一级评分</td><td>二级评分</td></tr>
								  			</thead>
								  			<tbody>
								  			<!-- 1 -->
								  			<tr>
											...
											/>
								  			...
								  			<thead>
								  			<tr class="tr-title"><td colspan="5">工作业绩（业务类）</td></tr>
								  			<tr class="tr-title"><td>KPI指标</td><td>工作自评</td><td>分值</td><td>一级评分</td><td>二级评分</td></tr>
								  			</thead>
								  			<tbody>
								  			<!-- 1 -->
								  			<tr>
