				...
				<article class="m-widget">
					<header style="height: 30px; margin-top: 0px; margin-bottom: 5px;border: solid #858585 1px;">
							...
							<c:if test="${item.taskId != null}">
								<button onclick="if(validBeforeSubmit()) getNextActivityDetails('${item.taskId}');"
						...
						<table class="table-input">
							...
							<tbody>
							    ...
							    <tr>
									...
									<!--  
								  	<td>
								  		<label class="td-label" for="RQ">日期</label>
								  	</td>
									<td>
										<van:input id="RQ"
											value="${item.RQ}"
									...
									<td>
								  		<label class="td-label" for="SJD">时间段</label>
								  	</td>
									<td>
										<van:input id="SJD"
											value="${item.SJD}"
