				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>动作字段管理</div>
						</div>
										...
										<table id="dynamicGrid" class="m-table table-striped table-bordered table-hover">
											<thead>
								                <tr>
								                    ...
								                    <th class="sorting" name="FRE_ACTION_TYPE_ID">动作类型</th>
								                    <th class="sorting" name="FIELD_NAME">字段名</th>
								                    <th class="sorting" name="FIELD_COLUMN">字段(库)</th>
								                    <th class="sorting" name="FIELD_TYPE">字段类型</th>
											...
											<c:forEach items="${pageView.results}" var="item">
								                <tr>
								                    ...
								                    <td>${item.fieldColumn}</td>
								                    <td>${item.fieldType}</td>
								                    <td>${item.required == 'T' ? '是' : '否'}</td>
								                    <td>${item.participate == 'T' ? '是' : '否'}</td>
