				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>成本管理</div>
						</div>
						<div class="portlet-body">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="fre-price-list.do" class="form-inline">
							...
							<article class="m-widget">
									<form id="dynamicGridForm" name="dynamicGridForm" action="fre-price-remove.do" class="m-form-dynamic" method="post">
