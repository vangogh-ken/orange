				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>动作模板管理</div>
						</div>
						<div class="portlet-body">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="fre-data-template-list.do" class="form-inline">
								    ...
								    <label for="freightActionTypeId">动作类型</label>
								    <select id="freightActionTypeId" name="freightActionTypeId" class="form-control">
								    	...
								    	<c:forEach items="${freightActionTypes}" var="freightActionType">
								    		<option value="${freightActionType.id}" <c:if test="${freightActionType.id == param.freightActionTypeId}">selected</c:if> >${freightActionType.typeName}</option>
								    	</c:forEach>
								    </select>
							...
							<article class="m-widget">
									<form id="dynamicGridForm" name="dynamicGridForm" action="fre-data-template-remove.do" class="m-form-dynamic" method="post">
