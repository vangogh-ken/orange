				...
				<div class="row">
				  <div class="col-md-12">
				  	<div class="portlet box red">
						...
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="fre-net-day-save-fas.do?operationMode=STORE" class="form-horizontal"  >
    ...
    $(function() {
        $("#editDomainForm").validate({
            submitHandler: function(form) {
                if(($('#regular').val() == 'T' && $('#delayMonth').val() != 0 && $('#regularDay').val() != 0)
                		|| ($('#regular').val() == 'F' && $('#period').val() != 0)){
