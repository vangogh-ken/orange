				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>费用信息</div>
						</div>
							...
							<form id="editDomainForm" method="post" action="fre-box-save.do?operationMode=STORE" class="form-horizontal">
								 ...
								 <div class="form-body">
									<table class="table-input" style="margin-left:10%;width:80%">
										<thead>
											<tr><th colspan="6">费用信息</th></tr>
										</thead>
										<tbody>
											<tr>
												<td>
													<label class="td-label" for="freightExpenseTypeId">费用类型</label>
												</td>
												<td>
												...
												<td>
													<label class="td-label" for="金额">箱型</label>
												</td>
												<td>
