				...
				<div class="row">
				  <div class="col-md-12">
				  	<div class="portlet box red">
						...
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="fre-seal-save.do?operationMode=STORE" class="form-horizontal">
								 ...
								 <div class="form-body">
									<table class="table-input" style="margin-left:10%;width:80%">
										...
										<tbody>
											<tr>
												<td>
													<label class="td-label" for="sealNumber">封号</label>
												</td>
												<td>
													<input id="sealNumber" type="text" name="sealNumber" value="${item.sealNumber}" 
											...
											<tr>
												...
												<td colspan="3">
													...
													${item.descn == null ? '无' : item.descn}</textarea>
												</td>
											</tr>
										</tbody>
									</table>
