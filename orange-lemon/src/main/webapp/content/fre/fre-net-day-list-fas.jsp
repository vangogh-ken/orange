				  	...
				  	<div class="portlet box red">
						...
						<div class="portlet-body">
							<article class="m-widget" id="btnAcrticle">
								<div class="pull-left">
									<button class="btn btn-sm red" onclick="location.href='fre-net-day-input-fas.do'">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="fre-net-day-list-fas.do" class="form-inline">
							...
							<article class="m-widget">
									<form id="dynamicGridForm" name="dynamicGridForm" action="fre-net-day-remove-fas.do" class="m-form-dynamic">
										<table id="dynamicGrid" class="m-table table-striped table-bordered table-hover">
											...
											<c:forEach items="${pageView.results}" var="item">
								                <tr>
								                    ...
								                    <td>${item.status}</td>
								                    <td>
								                    	<a href="fre-net-day-input-fas.do?id=${item.id}" class="btn btn-sm red">编辑</a>
								                    </td>
								                </tr>
											</c:forEach>
								            </tbody>
