										...
										<table id="dynamicGrid" class="m-table table-striped table-bordered table-hover">
											<thead>
								                <tr>
								                    ...
								                    <th class="sorting" name="ACTION_TYPE_ID">动作名称</th>
								                    <th class="sorting" name="MAINTAIN_ID">操作范围</th>
								                    <th class="sorting" name="MAINTAIN_ID">业务号</th>
								                    <th class="sorting" name="DELEGATE">是否有委托</th>
								                    <th class="sorting" name="INTERNAL">是否对内部</th>
								                    <th class="sorting" name="PRIME">是否需要填报</th>
											...
											<c:forEach items="${pageView.results}" var="item">
								                <tr>
								                    ...
								                    <td>${item.freightActionType.typeName}</td>
								                    <td>${item.freightMaintain.freightMaintainType.typeName}</td>
								                    <td>${item.freightMaintain.freightOrder.orderNumber}</td>
								                    <td>${item.delegate}</td>
								                    <td>${item.internal}</td>
								                    <td>${item.prime}</td>
								                    <td>${item.status}</td>
