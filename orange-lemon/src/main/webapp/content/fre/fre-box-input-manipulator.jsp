				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>集装箱信息(操作)</div>
						</div>
						<div class="portlet-body form">
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="fre-box-save-manipulator.do?operationMode=STORE" class="form-horizontal">
								 ...
								 <div class="form-body">
									<table class="table-input" style="margin-left:20%;width:60%">
										<thead>
											<tr><th colspan="6">集装箱信息(操作)</th></tr>
										</thead>
										<tbody>
											<tr>
												<td>
												...
												<td>
													<select id="boxSource" name="boxSource" class="form-control required">
														<option value="外理箱" <c:if test="${item.boxSource == '外理箱' }">selected</c:if>>外理箱</option>
													</select>
												</td>
												<td>
