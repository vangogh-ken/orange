				  	...
				  	<div class="portlet box red">
						...
						<div class="portlet-body">
							<article class="m-widget" id="btnAcrticle">
								<div class="pull-left">
									<!--  
										<button class="btn btn-sm red" onclick="location.href='fre-order-box-input.do'">
									...
									-->		
										...
										<button class="btn btn-sm green" id="reviseFreightBox">
											修改箱号</button>
										<!--	
										<button class="btn btn-sm red" id="reviseRailSeal">
											配铁路封</button>
										 	
										<button class="btn btn-sm red" id="reviseRailTurn">
											批量班列</button>
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="fre-order-box-list-manipulator.do" class="form-inline">
