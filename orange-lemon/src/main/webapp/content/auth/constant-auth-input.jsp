				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>权限常量信息</div>
						</div>
						<div class="portlet-body form">
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="constant-auth-save.do?operationMode=STORE" class="form-horizontal">
								 ...
								 <div class="form-body">
									<table class="table-input" style="margin-left:20%;width:60%">
										...
										<tbody>
											<tr>
												<td>
													<label class="td-label" for="authType">常量类型</label>
												</td>
												<td>
													<select id="authType" name="authType" class="form-control required">
														<option value="NORMAL"<c:if test="${item.authType == 'NORMAL'}">selected</c:if> >通用</option>
													</select>
												</td>
												<td>
											...
											<tr>
												<td>
													<label class="td-label" for="constantName">常量名称</label>
												</td>
												<td colspan="3">
													<input id="constantName" type="text" name="constantName" value="${item.constantName}" 
