  ...
  <body class="page-header-fixed">
				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>权限常量管理</div>
						</div>
						<div class="portlet-body">
							<article class="m-widget" id="btnAcrticle">
								<div class="pull-left">
									<button class="btn btn-sm red" onclick="location.href='constant-auth-input.do'">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="constant-auth-list.do" class="form-inline">
							...
							<article class="m-widget">
									<form id="dynamicGridForm" name="dynamicGridForm" action="constant-auth-remove.do" class="m-form-dynamic" method="post">
										<table id="dynamicGrid" class="m-table table-striped table-bordered table-hover">
											<thead>
								                <tr>
								                	<th class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
								                    <th class="sorting" name="AUTH_TYPE">常量类型</th>
								                    <th class="sorting" name="CONSTANT_NAME">常量名称</th>
								                    <th class="sorting" name="STATUS">状态</th>
								                    <th class="sorting" name="DESCN">说明</th>
								                    <th class="sorting" name="CREATE_TIME">修改时间</th>
								                    <th>操作</th>
								                </tr>
								            </thead>
								            <tbody>
											<c:forEach items="${pageView.results}" var="item">
								                <tr>
								                    ...
								                    <td >
								                    	<a href="constant-auth-input.do?id=${item.id}" class="btn btn-sm red">编辑</a>
								                    </td>
								                </tr>
											</c:forEach>
								            </tbody>
			...
			<div class="modal-body">
				...
				<article class="m-widget">
					<form id="basisAttributeBtnForm" name="basisAttributeBtnForm" method="post" action="" class="form-inline" onsubmit="return false;">
						<button type="button" class="btn btn-sm red" onclick="$('#basisAttributeToAddForm').submit()">确定</button>
	...
	function reviseBasisAttribute(){
		if($('#basisAttributeHasAddForm .selectedItemId:checked').length != 1){
			...
			var url = 'basis-attribute-to-revise-attribute.do?basisAttributeId=' + basisAttributeId;
