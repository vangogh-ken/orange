				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-bullhorn"></i>公告栏目管理</div>
						</div>
						<div class="portlet-body">
							<article class="m-widget" id="btnAcrticle">
								<div class="pull-left">
									<sec:authorize ifAnyGranted="ROLE_AUTH-USER-LIST-ADD">
										<button class="btn btn-sm red" onclick="location.href='cms-catalog-input.do'">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="cms-catalog-list.do" class="form-inline">
							...
							<article class="m-widget">
									<form id="dynamicGridForm" name="dynamicGridForm" action="cms-catalog-remove.do" class="m-form-dynamic">
										<table id="dynamicGrid" class="m-table table-striped table-bordered table-hover">
											<thead>
								                <tr>
								                    ...
								                    <th class="sorting" name="KEYWORD">关键词</th>
											...
											<c:forEach items="${pageView.results}" var="item">
								                <tr>
								                    ...
								                    <td>${item.priority}</td>
								                    <td>
								                    	<a href="cms-catalog-input.do?id=${item.id}" class="btn btn-sm red">编辑</a>
								                    </td>
								                </tr>
											</c:forEach>
								            </tbody>
