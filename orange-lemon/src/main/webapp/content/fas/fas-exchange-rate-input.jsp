				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>汇率信息</div>
						</div>
						<div class="portlet-body form">
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="fas-exchange-rate-save.do?operationMode=STORE" class="form-horizontal">
									...
									<table class="table-input" style="margin-left:10%;width:80%">
										...
										<tbody>
											<tr>
												...
												<td>
													<input id="exchangeRate" type="text" name="exchangeRate" value="${item.exchangeRate}" 
											...
											<tr>
												...
												<td>
													...
													value="<fmt:formatDate value="${item.startTime == null ? now : item.startTime}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />" 
												...
												<td>
													...
													value="<fmt:formatDate value="${item.endTime == null ? now : item.endTime}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />" 
													class="form-control required datepicker" >
												</td>
											</tr>
											<tr>
