				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>票种信息</div>
						</div>
						<div class="portlet-body form">
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="fas-invoice-type-save.do?operationMode=STORE" class="form-horizontal">
								 ...
								 <div class="form-body">
									<table class="table-input" style="margin-left:10%;width:80%">
										...
										<tbody>
											...
											<tr>
												<td>
													<label class="td-label" for="typeName">票种</label>
												</td>
												<td>
													...
													vAttrId="5a487450-55d7-11e4-bdcd-a4db305e5cc5">
												</td>
												<td>
													<label class="td-label" for="taxRate">税率</label>
												</td>
												<td>
													<input id="taxRate" type="text" name="taxRate" value="${item.taxRate}" 
