				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>类别信息</div>
						</div>
						<div class="portlet-body form">
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="rep-category-save.do?operationMode=STORE" enctype="multipart/form-data" class="form-horizontal">
								 ...
								 <div class="form-body">
									<table class="table-input" style="margin-left:10%;width:80%">
										...
										<tbody>
											<tr>
												<td>
													<label class="td-label" for="categoryName">模板名称</label>
												</td>
												<td colspan="3">
    ...
    $(function() {
        $("#editDomainForm").validate({
            ...
            rules: {
            	categoryName: {
   	                remote: {
   	                    url: 'rep-category-check-categoryname.do',
   	                    data: {
   	                        <c:if test="${item.id != null}">
   	                        id: function() {
   	                            return $('#id').val();
