				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-align-justify"></i>福利信息</div>
						</div>
						<div class="portlet-body form">
						<!-- BEGIN FORM-->
							<form id="editDomainForm" method="post" action="motor-weal-save.do?operationMode=STORE" class="form-horizontal">
									...
									<table class="table-input" style="margin-left:10%;width:80%">
										...
										<tbody>
											<tr>
												...
												-->
												<td>
													<label class="td-label" for="status">状态 *使用默认</label>
												</td>
												<td >
											...
											<tr>
												<td>
													<label class="td-label" for=wealTime>福利时间</label>
												</td>
												<td>
													<input id="wealTime" type="text" name="wealTime" value='<fmt:formatDate value="${item.wealTime}" pattern="yyyy-MM-dd"/>'
													class="form-control required datepicker" 
													>
												</td>
												<td>
													<label class="td-label" for="wealType">福利类型</label>
												</td>
												<td>
													<input id="wealType" type="text" name="wealType" value="${item.wealType}" 
													 class="form-control required dictionary" 
													vAttrId="4b91cf9e-308c-11e5-b95a-b870f47f73d5">
												</td>
											</tr>
											<tr>
												<td>
