				  ...
				  <div class="col-md-12">
				  	<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-calendar"></i>工作日历时间管理</div>
						</div>
						<div class="portlet-body">
							<article class="m-widget" id="btnAcrticle">
								<div class="pull-left">
									<sec:authorize ifAnyGranted="ROLE_AUTH-USER-LIST-ADD">
										<button class="btn btn-sm red" onclick="location.href='work-cal-part-input.do'">
										...
										<table id="dynamicGrid" class="m-table table-striped table-bordered table-hover">
											<thead>
								                <tr>
								                    ...
								                    <th class="sorting" name="RULE_ID">规则</th>
								                    <th class="sorting" name="SHIFT">上午/下午</th>
											...
											<c:forEach items="${pageView.results}" var="item">
								                <tr>
								                    ...
								                    <td>${item.shift==0? '上午':'下午'}</td>
								                    <td>${item.startTime}</td>
								                    <td>${item.endTime}</td>
								                    <td>
								                    	<a href="work-cal-part-input.do?id=${item.id}" class="btn btn-sm red">编辑</a>
								                    </td>
								                </tr>
											</c:forEach>
								            </tbody>
