				  ...
				  <div class="col-md-12">
				  	<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-envelope"></i>新邮件</div>
						</div>
							...
							<form id="editDomainForm" method="post" action="mail-send-to.do?operationMode=STORE" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="col-md-9">
												...
												<button type="submit" class="btn btn-sm green">草稿</button>
												<button type="button" class="btn btn-sm default" onclick="history.back();">取消</button>
											</div>
										</div>
										<div class="col-md-6">
										</div>
								 ...
								 <div class="form-body">
									<table class="table-input" style="margin-left:20%;width:60%">
										<thead>
											<tr><th colspan="6" style="text-align: left;">新邮件</th></tr>
										</thead>
										<tbody>
											<tr>
												...
												<td >
													<div class="input-icon right userPicker">
		 	 											...
		 	 											<!--  
		 	 											<input type="text" id="addressTo" class="form-control"/>
		 	 											-->
														<input type="text" id="addressTo" name="addressTo" value="${item.addressTo}" class="form-control required">
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="text" id="subject" name="subject" value="${item.subject}" class="form-control required">
												</td>
											</tr>
											<!--  
											<tr>
											...
											<tr>
												...
												<td >
													<textarea id="content" name="content" class="form-control required"
														style="min-height:250px;">${item.content}</textarea>
												</td>
											</tr>
										</tbody>
									</table>
