				...
				<div class="row">
				  <div class="col-md-12">
				  	<div class="portlet box red">
						...
						<!-- BEGIN FORM-->
							<form id="assistForm" method="post" action="workspace-task-assist.do?operationMode=STORE" class="form-horizontal">
  ...
  <!--  
    ...
    <section id="m-main" class="span10" style="float:right">
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title">协办任务</h4>
		</header>

		<div class="content content-inner">

<form id="assistForm" method="post" action="workspace-task-assist.do" class="form-horizontal">
  <input id="taskId" type="hidden" name="taskId" value="${param.taskId}">
