  ...
  <body class="page-header-fixed">
				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-sitemap"></i>流程实例管理</div>
						</div>
						<div class="portlet-body">
							<article class="m-widget" id="btnAcrticle">
								<div class="pull-left">
									...
									<sec:authorize ifAnyGranted="ROLE_AUTH-USER-LIST-ADD">
										<button class="btn btn-sm red" onclick="location.href='department-input.do'">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="bpm-process-instance-list.do" class="form-inline">
							    	...
							    	<label for="involvedUserName">参与人</label>
							    	<input type="text" id="involvedUserName" name="involvedUserName" value="${param.involvedUserName}" class="form-control">
							...
							<article class="m-widget">
									<form id="dynamicGridForm" name="dynamicGridForm" action="bpm-process-instance-remove.do" class="m-form-dynamic">
									      ...
									      <tbody>
									       <c:forEach items="${pageView.results}" var="item">
									        <tr>
									          ...
									          <td>
									          		${item.deleteReason == null && item.endTime != null? "正常结束" :
									          		 (item.deleteReason==null && item.endTime == null? "正在运行" : item.deleteReason)}
									          </td>
									          <td>
									          ...
									          <td>
									          	...
									          	<a class="btn btn-sm red" href="bpm-process-log.do?processInstanceId=${item.id}">日志</a>
									          	<a class="btn btn-sm green" onclick="showGraph('${item.processInstanceId}')">流程图</a>
									          	<c:if test="${item.endTime==null && item.deleteReason == null}"></c:if>
									          	<!--  
									          	<a class="btn btn-sm red" href="bpm-process-instance-delete.do?id=${item.id}">删除</a>
									          	-->
									          	<a class="btn btn-sm green" href='console-migrate-input.do?processInstanceId=${item.id}'>数据迁移</a>
									          </td>
									        </tr>
									        </c:forEach>
									      </tbody>
	...
	var config = {
	 	    ...
	 	    params: {
	 	        ...
	 	        'involvedUserName': '${param.involvedUserName}',
