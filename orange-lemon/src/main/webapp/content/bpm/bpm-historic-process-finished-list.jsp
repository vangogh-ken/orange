				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-sitemap"></i>流程实例列表(已结束)</div>
						</div>
						<div class="portlet-body">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="bpm-historic-process-finished-list.do" class="form-inline">
									      ...
									      <tbody>
									       <c:forEach items="${pageView.results}" var="item">
									        <tr>
									          ...
									          <td>
									            <a class="btn btn-sm red" href="bpm-process-business-view.do?businessKey=${item.businessKey}&processKey=<%=ProcessDefinitionCache.getProcessKey(pageContext.getAttribute("processDefinitionId").toString())%>" target="_blank">查看</a>
									          	<a class="btn btn-sm red" onclick="showGraph('${item.processInstanceId}')">流程图</a>
									          	<c:if test="${item.endTime==null && item.deleteReason == null}">
