...
<html lang="en">
  ...
  <body class="page-header-fixed">
				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-sitemap"></i>待领任务</div>
						</div>
						<div class="portlet-body">
							...
							<article class="m-widget" id="searchAcrticle">
								<form name="searchForm" method="post" action="bpm-task-claim-list.do" class="form-inline">
							...
							<article class="m-widget">
									<form id="dynamicGridForm" name="dynamicGridForm" action="bpm-task-claim-remove.do" class="m-form-dynamic">
									      ...
									      <tbody>
									        ...
									        <tr>
									          ...
									          <td>
									          	...
									          	<a class="btn btn-sm green" href="workspace-task-claim.do?taskId=${item.id}">签收</a>
	...
	var config = {
	 		...
	 		exportUrl: 'bpm-task-claim-export.do'
	};
