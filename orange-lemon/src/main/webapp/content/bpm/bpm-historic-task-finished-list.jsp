				  ...
				  <div class="col-md-12">
				  	<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-sitemap"></i>任务列表(已完成)</div>
						</div>
									      ...
									      <tbody>
									        <c:forEach items="${pageView.results}" var="item">
									         <tr>
									          ...
									          <td>
									           	<fmt:formatDate value="${item.claimTime == null ? item.startTime : item.claimTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
									          </td>
