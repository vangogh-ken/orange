...
public class PaseXml {
	...
	public static Document load(String filename) {
		...
		try {
			...
			// Document对象调用normalize()，可以去掉XML文档中作为格式化内容的空白而映射在DOM树中的不必要的Text
			// Node对象。
	...
	public static void main(String args[]) throws Exception {
		...
		List<String> ls = httpClientUtils
				.getLinkTagsContent("http://v.youku.com/v_show/id_XNTM4NjY5MDgw.html?f=19121485");
