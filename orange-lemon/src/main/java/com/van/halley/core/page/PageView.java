package com.van.halley.core.page;

import java.util.List;

import com.van.halley.util.PageIndex;
import com.van.halley.util.WebTool;
...
public class PageView<T> {
	...
	public PageView(int pageSize, int pageNo, String orderBy, String order) {
		this.pageSize = pageSize;
		this.pageNo = pageNo;
	...
	public void setQueryResult(long totalCount, List<T> results) {
