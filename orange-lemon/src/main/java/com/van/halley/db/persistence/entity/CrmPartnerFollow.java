...
public class CrmPartnerFollow implements Serializable{
	/**
	...
	public CrmPartner getCrmPartner() {
		return crmPartner;
	}
	public void setCrmPartner(CrmPartner crmPartner) {
		this.crmPartner = crmPartner;
	}
