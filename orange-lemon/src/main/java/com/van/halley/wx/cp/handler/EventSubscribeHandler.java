...
public class EventSubscribeHandler implements WxCpMessageHandler{
	private static Logger LOG = LoggerFactory.getLogger(EventSubscribeHandler.class);
	...
	public WxCpXmlOutMessage handle(WxCpXmlMessage wxMessage, Map<String, Object> context, WxCpService wxCpService,
		...
		if(WX.Type.EVENT.equalsIgnoreCase(wxMessage.getMsgType()) 
				&& WX.Event.SUBSCRIBE.equalsIgnoreCase(wxMessage.getEvent())){
			if(userBase != null){
