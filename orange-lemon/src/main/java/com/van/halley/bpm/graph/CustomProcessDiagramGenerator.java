package com.van.halley.bpm.graph;
...
public class CustomProcessDiagramGenerator {
	private static Logger logger = LoggerFactory
            .getLogger(CustomProcessDiagramGenerator.class);
	public static final int OFFSET_SUBPROCESS = 5;
	//activiti 5.16 修改了图像绘制,任务为矩形,因此此处的圆角需要修改下
	//public static final int OFFSET_TASK = 20;
	public static final int OFFSET_TASK = 6;
	...
	private static Color HISTORY_COLOR = new Color(2, 100, 2);
	...
	public InputStream generateDiagram(String processInstanceId)
		...
		//logger.debug("minX {} minY {}", point.x, point.y);
		logger.info("minX {} minY {}", point.x, point.y);
		this.minX = point.x;
		this.minY = point.y;
	 ...
	 * 修改为public， 获取图像的基本位置
	 */
	public Point getMinXAndMinY(BpmnModel bpmnModel) {
		...
		//5.18将图片位置恢复至设计时位置, 此处将图片的初始位置直接设置为0
