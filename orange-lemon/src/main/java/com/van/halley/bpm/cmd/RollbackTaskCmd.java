...
import com.van.halley.bpm.graph.ActivitiHistoryGraphBuilder;
import com.van.halley.bpm.graph.Edge;
import com.van.halley.bpm.graph.Graph;
import com.van.halley.bpm.graph.Node;
...
public class RollbackTaskCmd implements Command<Integer> {
    ...
    public void processHistoryTask(
        ...
        //task.setAssignee(historicTaskInstanceEntity.getAssignee(), true, true);
      ...
      //修改业务数据状态
        BpmConfigNodeService bpmConfigNodeService =  
        		ApplicationContextHelper.getBean(BpmConfigNodeService.class);
        bpmConfigNodeService.updateBasisSubstance(task);
    }
