 ...
 */
package com.van.core.juel.tree.impl;

import static com.van.core.juel.tree.impl.Builder.Feature.METHOD_INVOCATIONS;
import static com.van.core.juel.tree.impl.Builder.Feature.NULL_PROPERTIES;
import static com.van.core.juel.tree.impl.Scanner.Symbol.COLON;
import static com.van.core.juel.tree.impl.Scanner.Symbol.COMMA;
import static com.van.core.juel.tree.impl.Scanner.Symbol.EMPTY;
import static com.van.core.juel.tree.impl.Scanner.Symbol.END_EVAL;
import static com.van.core.juel.tree.impl.Scanner.Symbol.EOF;
import static com.van.core.juel.tree.impl.Scanner.Symbol.FALSE;
import static com.van.core.juel.tree.impl.Scanner.Symbol.FLOAT;
import static com.van.core.juel.tree.impl.Scanner.Symbol.IDENTIFIER;
import static com.van.core.juel.tree.impl.Scanner.Symbol.INTEGER;
import static com.van.core.juel.tree.impl.Scanner.Symbol.LPAREN;
import static com.van.core.juel.tree.impl.Scanner.Symbol.MINUS;
import static com.van.core.juel.tree.impl.Scanner.Symbol.NOT;
import static com.van.core.juel.tree.impl.Scanner.Symbol.NULL;
import static com.van.core.juel.tree.impl.Scanner.Symbol.QUESTION;
import static com.van.core.juel.tree.impl.Scanner.Symbol.RBRACK;
import static com.van.core.juel.tree.impl.Scanner.Symbol.RPAREN;
import static com.van.core.juel.tree.impl.Scanner.Symbol.START_EVAL_DEFERRED;
import static com.van.core.juel.tree.impl.Scanner.Symbol.START_EVAL_DYNAMIC;
import static com.van.core.juel.tree.impl.Scanner.Symbol.STRING;
import static com.van.core.juel.tree.impl.Scanner.Symbol.TEXT;
import static com.van.core.juel.tree.impl.Scanner.Symbol.TRUE;
...
import com.van.core.juel.misc.LocalMessages;
import com.van.core.juel.tree.FunctionNode;
import com.van.core.juel.tree.IdentifierNode;
import com.van.core.juel.tree.Tree;
import com.van.core.juel.tree.impl.Builder.Feature;
import com.van.core.juel.tree.impl.Scanner.ScanException;
import com.van.core.juel.tree.impl.Scanner.Symbol;
import com.van.core.juel.tree.impl.Scanner.Token;
import com.van.core.juel.tree.impl.ast.AstBinary;
import com.van.core.juel.tree.impl.ast.AstBoolean;
import com.van.core.juel.tree.impl.ast.AstBracket;
import com.van.core.juel.tree.impl.ast.AstChoice;
import com.van.core.juel.tree.impl.ast.AstComposite;
import com.van.core.juel.tree.impl.ast.AstDot;
import com.van.core.juel.tree.impl.ast.AstEval;
import com.van.core.juel.tree.impl.ast.AstFunction;
import com.van.core.juel.tree.impl.ast.AstIdentifier;
import com.van.core.juel.tree.impl.ast.AstMethod;
import com.van.core.juel.tree.impl.ast.AstNested;
import com.van.core.juel.tree.impl.ast.AstNode;
import com.van.core.juel.tree.impl.ast.AstNull;
import com.van.core.juel.tree.impl.ast.AstNumber;
import com.van.core.juel.tree.impl.ast.AstParameters;
import com.van.core.juel.tree.impl.ast.AstProperty;
import com.van.core.juel.tree.impl.ast.AstString;
import com.van.core.juel.tree.impl.ast.AstText;
import com.van.core.juel.tree.impl.ast.AstUnary;
