 ...
 * @author Joram Barrez
 */
public class DefaultProcessDiagramCanvas2 {

  protected static final Logger LOGGER = LoggerFactory.getLogger(DefaultProcessDiagramCanvas2.class);
  ...
  protected static Font ANNOTATION_FONT = new Font("宋体", Font.PLAIN, FONT_SIZE);
   ...
   * 
   */
  public DefaultProcessDiagramCanvas2(int width, int height, int minX, int minY, String imageType, 
